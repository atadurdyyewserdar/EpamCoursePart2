package main.by.javatr.task1.parser;

import main.by.javatr.task1.entity.Point;
import main.by.javatr.task1.entity.Quadrangle;
import main.by.javatr.task1.generator.IdGenerator;
import main.by.javatr.task1.parser.exception.ParserException;
import main.by.javatr.task1.validator.QuadrangleValidator;
...
public class QuadrangleParser {
    ...
    public Quadrangle parse(String line) throws ParserException {
        ...
        if (!quadrangleValidator.isCorrectQuadrangle(a, b, c, d)) {
            logger.fatal("Wrong Quadrangle data");
